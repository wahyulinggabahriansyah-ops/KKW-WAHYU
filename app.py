...
<style>
    * {
    ...
    .teks-judul { color: #FFFFFF; font-size: 36px; font-weight: bold; margin-top: 10px; margin-bottom: 25px; padding-left: 180px; padding-right: 180px; line-height: 1.2; }
...
while True:
    ...
    with placeholder.container():
        ...
        <div class="led-container">
            <img src="data:image/png;base64,{logo_kemenhub_base64}" width="75" style="position: absolute; top: 15px; right: 100px; object-fit: contain;">
